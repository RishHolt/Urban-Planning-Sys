...
class ClearanceApplicationService
{
     ...
     */
    public function createApplication(array $data): ClearanceApplication
    {
        $referenceNo = null;
        $application = null;
     ...
     */
    protected function verifyPrerequisites(ClearanceApplication $application, array $data): void
    {
     ...
     */
    public function updateStatus(ClearanceApplication $application, string $newStatus, ?string $remarks, ?string $denialReason, int $updatedBy): void
    {
