...
return new class extends Migration
{
     ...
     * Uses 'zcs_db' connection for notifications.
     */
    ...
    {
        Schema::connection('zcs_db')->create('notifications', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('zcs_db')->dropIfExists('notifications');
    }
};
