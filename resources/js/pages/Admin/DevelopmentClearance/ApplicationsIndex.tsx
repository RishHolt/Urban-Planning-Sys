...
export default function ApplicationsIndex({ applications, filters: initialFilters = {} }: ApplicationsIndexProps) {
    ...
    const handleReset = (): void => {
        ...
        router.get('/admin/development-clearance/applications');
    };
    ...
    const getProjectTypeBadge = (projectType: string) => {
        const colors = projectType === 'subdivision_only' 
            ? 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300'
            : 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300';
        
        return (
            <span className={`px-2 py-1 rounded-full text-xs font-medium ${colors}`}>
                {projectType === 'subdivision_only' ? 'Subdivision Only' : 'Subdivision + Building'}
            </span>
        );
    };
                    ...
                    <>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="subdivision_only">Subdivision Only</option>
                                <option value="subdivision_with_building">Subdivision + Building</option>
                            </select>
                        </div>
                    </>
                }
                            ...
                            {applications.data.length === 0 ? (
                                ...
                                applications.data.map((app) => (
                                    <tr key={app.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            {getProjectTypeBadge(app.projectType)}
                                        </td>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            {app.buildingReviewStatus ? (
                                                getStatusBadge(app.buildingReviewStatus)
                                            ) : (
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <Link
                                                href={`/admin/development-clearance/applications/${app.id}`}
