            ...
            <div className="max-w-4xl mx-auto space-y-6">
                ...
                <div className="bg-white dark:bg-dark-surface rounded-lg shadow-md p-6">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            <span className="text-sm text-gray-500 dark:text-gray-400">Application Category</span>
                            <p className="mt-1 text-sm font-medium text-gray-900 dark:text-white capitalize">
                                {clearance.clearanceApplication.application_category.replace('_', ' ')}
                            </p>
                        </div>
                        <div>
                ...
                <div className="bg-white dark:bg-dark-surface rounded-lg shadow-md p-6">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-3">
                            ...
                            <Link href="/admin/clearance/applications">
